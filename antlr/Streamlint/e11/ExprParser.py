...
def serializedATN():
    return [
        4,1,20,15,2,0,7,0,2,1,7,1,1,0,5,0,6,8,0,10,0,12,0,9,9,0,1,0,1,0,
        1,1,1,1,1,1,0,0,2,0,2,0,1,1,0,1,19,13,0,7,1,0,0,0,2,12,1,0,0,0,4,
...
class ExprParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "PUBLIC", "CLASS", "STATIC", "VOID", 
                      "INT", "MAS", "IGUAL", "PAR_IZQ", "PAR_DER", "LLAVE_IZQ", 
                      "LLAVE_DER", "COR_IZQ", "COR_DER", "PUNTO_COMA", "PUNTO", 
                      "COMA", "ENTERO", "CADENA", "IDENTIFICADOR", "WS" ]
